   ...
   <div class="order-right">
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="myOrderList in myOrder.records" :key="myOrderList.id">
                <thead>
                  <tr>
                    <th colspan="5">
                      <span class="ordertitle">{{myOrderList.createTime}}　订单编号：{{ myOrderList.outTradeNo }}<span
          ...
          <Pagination :pageNo="page" :pageSize="limit" :total="myOrder.total" :continues="5" @getPage="getPage"/>
...
export default {
    ...
    methods: {
     async getData(){
       let result= await this.$API.resMyOrderList(this.page,this.limit);
      //  console.log(result);
      if(result.code==200){
        // 将数据存储到组件实例上
